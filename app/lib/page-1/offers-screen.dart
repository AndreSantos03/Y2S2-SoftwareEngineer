        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              ...
              child: Container(
                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 6*fem, 52*fem),
            ...
            Container(
              // frameJWR (21:154)
              margin: EdgeInsets.fromLTRB(14*fem, 0*fem, 20*fem, 48*fem),
              width: double.infinity,
              height: 501*fem,
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(19*fem, 20*fem, 17*fem, 20*fem),
                    width: double.infinity,
                  ...
                  Container(
                    ...
                    padding: EdgeInsets.fromLTRB(23*fem, 19*fem, 17*fem, 21*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                      color: Color(0xd3fffcfc),
                      borderRadius: BorderRadius.circular(100*fem),
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 0*fem, 21*fem),
                    padding: EdgeInsets.fromLTRB(18*fem, 19*fem, 17*fem, 21*fem),
                    width: double.infinity,
                    decoration: BoxDecoration (
                      color: Color(0xd3fffcfc),
                      borderRadius: BorderRadius.circular(100*fem),
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // ButtonOffers (21:80)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 32*fem, 0*fem),   // 66*fem -> overflow
                    width: 88*fem,
                    height: 88*fem,
                    child: Image.asset(
                  ...
                  TextButton(onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context) => const MapScreen()),);}, child:
                  Container(
                    // buttonmaprb7 (21:74)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 96*fem, 6*fem),
                    width: 52*fem,
                    height: 52*fem,
                    child: Image.asset(
