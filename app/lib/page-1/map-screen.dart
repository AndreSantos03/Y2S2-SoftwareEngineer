        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(48*fem, 0*fem, 29*fem, 19*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
              ),
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(18*fem, 0*fem, 11*fem, 47*fem),
              width: double.infinity,
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 318*fem, 1*fem),
                    width: 36*fem,
                    height: 36*fem,
                    child: Image.asset(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  Container(
                    // ButtonOffers
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 60*fem, 0*fem), // 87*fem was giving overflow
                    child: TextButton(
                      onPressed: () {
