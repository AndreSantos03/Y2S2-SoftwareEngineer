        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              margin: EdgeInsets.fromLTRB(12*fem, 0*fem, 0*fem, 248*fem),
              height: 30*fem,
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // iconsignalWfF (18:32)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 4.07*fem, 0*fem),
                    width: 26.04*fem,
                    height: 26.04*fem,
                    child: Image.asset(
                  ...
                  Container(
                    ...
                    margin: EdgeInsets.fromLTRB(0*fem, 2.44*fem, 0*fem, 6.4*fem),
                    width: 52.89*fem,
            ...
            Center(
              ...
              child: Container(
                margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 7*fem, 41*fem),
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(12*fem, 0*fem, 21*fem, 15*fem),
              width: double.infinity,
              height: 55*fem,
              child: Container(
            ...
            Container(
              ...
              margin: EdgeInsets.fromLTRB(13*fem, 0*fem, 20*fem, 227*fem),
              width: double.infinity,
              height: 55*fem,
              child: Container(
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    // buttonmapuKK (17:16)
                    margin: EdgeInsets.fromLTRB(0*fem, 0*fem, 77*fem, 6*fem),
                    width: 52*fem,
                    height: 52*fem,
                    child: Image.asset(
